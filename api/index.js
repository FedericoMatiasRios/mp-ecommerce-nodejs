...
app.get('/detail', async function (req, res) {
  try {
      ...
      const initPointTry = 'https://www.mercadopago.com.ar/checkout/v1/payment/modal/?preference-id=' + response.data.id + '&from-widget=true&sniffing-rollout=sniffing-api';

      console.log('preference:', response.data);

      res.render('detail', { view: 'detail', title, price, unit, preference: response.data, initPoint, initPointTry });
  } catch (error) {
